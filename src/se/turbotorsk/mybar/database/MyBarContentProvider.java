...
public class MyBarContentProvider extends ContentProvider{
    ...
    static {
    	/*
	     * Sets the integer value for multiple rows in DrinkTable to 1. Notice that no wildcard is used
	     * in the path
	     */
	    sUriMatcher.addURI(AUTHORITY, "drink", 1);
	     ...
	     */
	    sUriMatcher.addURI(AUTHORITY, "drink/#", 2);
    }
	@Override
